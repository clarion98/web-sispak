...
<html>
  ...
  <body>
    ...
    <div class="container">
      <form class="form-signin" role="form" action="halawaluser.php" method="post">
      <button class="btn btn-lg btn-primary btn-block" type="konsul">Konsultasi</button>
      </form>
      <form class="form-signin" role="form" action="services.php" method="post">
      <button class="btn btn-lg btn-primary btn-block" type="info">Informasi</button>
      </form>
      <form class="form-signin" role="form" action="about.php" method="post">
      <button class="btn btn-lg btn-primary btn-block" type="kontak">About Me</button>
      </form>
    </div>
   ...
   <div class="site-footer login-footer">
      <div class="container">
        <div class="copyright clearfix text-center">
          <p><b>Copyright &copy; <?php echo date("Y"); ?> Created by <a href="#">Agus Darmawan</a>
          <!--
